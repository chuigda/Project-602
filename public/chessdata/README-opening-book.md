...
> The opening-book.json comes from [this repository](https://github.com/lichess-org/chess-openings), and converted to FEN - opening name - next moves mapping format with [this script](https://github.com/chuigda/Project-Ke2/blob/master/opening-book/tsv2book.py), for engine to use.
>
> Below is the content of original repository README.
